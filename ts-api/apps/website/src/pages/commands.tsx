...
const CommandsPage = ({
  ...
  return (
    <Layout
      languages={languages}
      title={t({ key: "commands" })}
      translations={translations}
      env={env}
    >
      <div className="flex flex-col gap-2">
        <h1 className="pb-4 text-2xl font-bold">{t({ key: "commands" })}</h1>
        ...
        <div className="flex flex-col gap-6">
          <table className="mt-2">
            ...
            <tbody>
              <tr>
                ...
                <TD>{t({ key: "cmd_desc_free" })}</TD>
              </tr>
              <tr>
                <Command>
                  <Code toCopy="/up">/up</Code>
                </Command>
                <TD>{t({ key: "cmd_desc_up" })}</TD>
              </tr>
              <tr>
                <Command>
                  <Code toCopy="/help">/help</Code>
                </Command>
                <TD>{t({ key: "cmd_desc_help" })}</TD>
              </tr>
              <tr>
                <Command>
                  <Code toCopy="/invite">/invite</Code>
                </Command>
                <TD>{t({ key: "cmd_desc_invite" })}</TD>
              </tr>
              <tr>
                <Command>
                  <Code toCopy="/vote">/vote</Code>
                </Command>
                <TD>{t({ key: "cmd_desc_vote" })}</TD>
              </tr>
            </tbody>
          </table>
          ...
          <div className="flex flex-col gap-3">
            <div className="text-sm text-gray-400 sm:text-base">
              <Markdown>{t({ key: "commands_only_manage_server" })}</Markdown>
            </div>
