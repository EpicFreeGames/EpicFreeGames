...
pub fn help_embed(translator: &Translator, language: &Language) -> Embed {
    return Embed {
        ...
        description: Some(format!(
            ...
            looking_for_commands = format!("📋 {}", translator.translate(
                "looking_for_commands",
                language,
                Some(&HashMap::from([(
                    "commandsLink",
            ...
            how_to_tutorial = format!("🎮 {}", translator.translate(
                "how_to_tutorial",
                language,
                Some(&HashMap::from([(
                    "tutorialLink",
            ...
            having_problems = format!("🤔 {}", translator.translate(
                "having_problems",
                language,
                Some(&HashMap::from([(
                    "supportServerLink",
            ...
            would_like_to_translate = format!("🚩 {}", bold(translator.translate(
                "would_you_like_to_translate",
                language,
                Some(&HashMap::from([(
                    "botName",
                    CONSTANTS.bot_name.as_str()
                )]))
            ))),
            if_would_like_to_translate =format!("- {}",  translator.translate(
                "if_would_like_to_translate",
                language,
                Some(&HashMap::from([(
                    "serverInvite",
