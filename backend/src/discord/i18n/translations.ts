...
import vi_website from "./t10s/vi/website.json";

import zh_TW_messages from "./t10s/zh-TW/messages.json";
import zh_TW_commands from "./t10s/zh-TW/commands.json";
import zh_TW_website from "./t10s/zh-TW/website.json";
...
export const translations: Map<string, Record<string, string>> = new Map([
	...
	["az", { ...az_commands, ...az_website, ...az_messages }],
	["bg", { ...bg_commands, ...bg_website, ...bg_messages }],
	["cs", { ...cs_commands, ...cs_website, ...cs_messages }],
	["de", { ...de_commands, ...de_website, ...de_messages }],
	["en", { ...en_commands, ...en_website, ...en_messages }],
	["es-ES", { ...es_ES_commands, ...es_ES_website, ...es_ES_messages }],
	// use es-ES translations for es
	["es", { ...es_ES_commands, ...es_ES_website, ...es_ES_messages }],
	["fa", { ...fa_commands, ...fa_website, ...fa_messages }],
	["fr", { ...fr_commands, ...fr_website, ...fr_messages }],
	["he", { ...he_commands, ...he_website, ...he_messages }],
	["hi", { ...hi_commands, ...hi_website, ...hi_messages }],
	["hu", { ...hu_commands, ...hu_website, ...hu_messages }],
	["id", { ...id_commands, ...id_website, ...id_messages }],
	["it", { ...it_commands, ...it_website, ...it_messages }],
	["ja", { ...ja_commands, ...ja_website, ...ja_messages }],
	["ka", { ...ka_commands, ...ka_website, ...ka_messages }],
	["ko", { ...ko_commands, ...ko_website, ...ko_messages }],
	["mk", { ...mk_commands, ...mk_website, ...mk_messages }],
	["nl", { ...nl_commands, ...nl_website, ...nl_messages }],
	["pl", { ...pl_commands, ...pl_website, ...pl_messages }],
	["pt-BR", { ...pt_BR_commands, ...pt_BR_website, ...pt_BR_messages }],
	["pt-PT", { ...pt_PT_commands, ...pt_PT_website, ...pt_PT_messages }],
	// use pt-PT translations for pt
	["pt", { ...pt_PT_commands, ...pt_PT_website, ...pt_PT_messages }],
	["ro", { ...ro_commands, ...ro_website, ...ro_messages }],
	["ru", { ...ru_commands, ...ru_website, ...ru_messages }],
	["sr", { ...sr_commands, ...sr_website, ...sr_messages }],
	["sr-CS", { ...sr_CS_commands, ...sr_CS_website, ...sr_CS_messages }],
