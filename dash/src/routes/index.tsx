  ...
  return (
    <Layout title="Dashboard">
      <div className={tw`flex flex-col gap-2`}>
        <div className={tw`grid grid-cols-1 gap-2 md:grid-cols-2`}>
          <DashItem title="Total servers in db" value={counts.total} />
          <DashItem title="Total commands" value={counts.totalCommands} />
        </div>

        <div className={tw`max:grid-cols-4 grid grid-cols-1 gap-2 md:grid-cols-2`}>
...
const DashItem = ({
  ...
  <div className={tw`flex flex-col gap-2 rounded-md bg-gray-600 p-3 md:items-center`}>
