...
const TermsOfServicePage = ({
  ...
  refers to EpicFreeGames and the EpicFreeGames Team.
  
  - **Device** means any device that can access the Service such as but not limited 
  to; a computer, a phone or a digital tablet.
  
  - **Service** collectively refers to the Website and the EpicFreeGames Discord bot.
  ...
  - **Website** refers to the EpicFreeGames website, accessible from [https://epicfreegames.net](https://epicfreegames.net)
  ...
  that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.
  ...
  or services. You further acknowledge and agree that the Company shall not 
  ...
  for business interruption, for personal injury, loss of privacy arising out 
  ...
  or undertaking, and makes no representation of any kind that the Service 
  ...
  to You. But in such a case the exclusions and limitations set forth in 
  ...
  [hi@epicfreegames.net](mailto:hi@epicfreegames.net)
      `}
      </TermsMarkdown>
    </Layout>
  );
