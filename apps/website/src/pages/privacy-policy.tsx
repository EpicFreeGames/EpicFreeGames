...
const PrivacyPolicyPage = ({
  ...
  <Layout
    languages={languages}
    title={t({ key: "privacy_policy", translations })}
...
to EpicFreeGames and the EpicFreeGames Team.

- **Country** refers to: Switzerland

- **Device** means any device that can access the Service such as but not limited to; a computer, 
a phone or a digital tablet.
...
the Service, to provide the Service on behalf of the Company, to perform services related to 
...
- **Website** refers to the EpicFreeGames website, accessible from 
[https://epicfreegames.net](https://epicfreegames.net)
...
with, or during negotiations of, any merger, reorganization or sale of some or all of our assets.
...
- **With other users**: when You share personal information or otherwise interact in ways 
that are publicly distributed or available to the public.
...
the security or to improve the functionality of Our Service, or We are legally obligated 
to retain this data for longer time periods.

## Transfer of Your Personal Data
Your information, including Personal Data, is processed at the Company's operating offices 
and in any other places where the parties involved in the processing are located. It 
