...
export const languages = new Map<string, ILanguage>([
  ...
  ["az", { code: "az", englishName: "Azerbaijani", nativeName: "Azərbaycan" }],
  ...
  ["es-ES", { code: "es-ES", englishName: "Spanish", nativeName: "Español" }],
  ...
  ["mk", { code: "mk", englishName: "Macedonian", nativeName: "Македонски" }],
  ...
  ["sr", { code: "sr", englishName: "Serbian", nativeName: "Српски" }],
  ["sr-CS", { code: "sr-CS", englishName: "Serbian (Cyrillic)", nativeName: "Српски (Ћирилица)" }],
