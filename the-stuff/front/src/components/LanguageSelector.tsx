    ...
    <Listbox value={selected} onChange={onChange}>
      <div className="relative">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="absolute mt-1 max-h-80 w-full overflow-auto rounded-lg border-[1px] border-gray-600 bg-gray-800 p-[0.4rem] text-sm outline-none sm:text-base">
